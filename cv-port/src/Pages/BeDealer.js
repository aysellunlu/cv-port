    ...
    <React.Fragment>
          ...
          <Container>
            <div className="dealer-line">
              ...
              <div className="dealer-text mb-5">
                ...
                info@cvport.com üzerinden iletişime geçebilirsiniz ya da
                isterseniz aşağıdaki bayilik formunu doldurarak bize
                ulaşabilirsiniz.
              </div>
            </div>
          </Container>
          <Container>
            <div className="dealer-header-text mt-5">
      ...
      {width <= 450 && (
        <div>
          ...
          <Container>
            <div className="dealer-line">
              <div className="mobile-dealer-header mb-2">
                CV Port Bayisi Olun, Birlikte Büyüyelim!
              </div>
              <div className="dealer-text mb-2">
                Türkiye'nin neresinde olursanız olun, teknoloji ya da insan
          ...
          <Container>
            <div className="dealer-header-text mt-5 mx-2">
              Bayilik Ön Başvuru Formu
            </div>
            <Form>
              <Row>
