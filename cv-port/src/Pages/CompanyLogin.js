              ...
              <Col lg={5}>
                <div className="mt-5 mb-5">
                  <Row>
                    <Col lg={6} xs={6}>
                      <div
                        className="selected-login text-center pb-5 pt-5 mt-3"
                        type="button"
                      >
        ...
        <div>
          <Container>
            <div className="mt-2 mb-5">
              <div
                className="selected-login text-center pb-2 pt-2 mt-3"
                type="button"
              >
              ...
              <a href="/kullanici-girisi">
                <div
                  className="nonselected-login px-2 text-center pb-2 pt-2 mt-3"
                  type="button"
                >
