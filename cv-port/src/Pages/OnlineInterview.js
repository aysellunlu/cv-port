  ...
  return (
    <React.Fragment>
            ...
            <Row>
              <Col lg={9}>
                <div className="text-center row">
                  <div className="col">
                  <video width="80%" height="300" controls="controls">
              ...
              <Col lg={3}>
                <div className="chatwindow-bg">
                  ...
                  <div className="scrolling">
                    ...
                    <div className="chatwindow-text px-2 ">
                      Emir Bey merhaba, sesim geliyor mu? Emir Bey merhaba,
                      sesim geliyor mu? Emir Bey merhaba, sesim geliyor mu?
                    </div>
                    <div className="chatwindow-text px-2 ">
                      Emir Bey merhaba, sesim geliyor mu? Emir Bey merhaba,
                      sesim geliyor mu? Emir Bey merhaba, sesim geliyor mu?
      ...
      {width <= 450 && (
        <div>
          <Container>
            <div className="header-bg mb-2 mt-3">
          ...
          <Container>
            <Row>
              <Col lg={9}>
                ...
                <div className="video-info-text mx-1">
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry. Lorem Ipsum has been the industry's
                    standard dummy text ever since the 1500s, when an unknown
