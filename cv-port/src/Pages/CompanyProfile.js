        ...
        <div>
          ...
          <div className="user-profile-card-bg px-2 pt-4 mb-3">
              <Row>
                ...
                <Col lg={2} xs={5}>
                  <img src={CompanyProfilePic} width="100%" />
                </Col>
              </Row>
              ...
              <div className="card-bold-text mt-2"> Şehir :</div>
            ...
            <Row>
              <Col>
                <div className="user-profile-card-bg p-4 mb-5 container">
                  <img src={AdressMap} width="100%"/>
                  <div className="user-profile-card-title pb-4 pt-4">ADRES</div>
                  <div className="profile-card-text">
                    <p>
                      Lorem Ipsum is simply dummy text of the printing and
