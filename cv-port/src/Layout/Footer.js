          ...
          <Container>
            <div className="text-center pt-2 pb-2">
              <Row>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={FooterLogo} width="50" alt="facebook logo" />
                  </div>
                </Col>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={Facebook} width="100%" alt="facebook logo" />
                  </div>
                </Col>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={Twitter} width="100%" alt="facebook logo" />
                  </div>
                </Col>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={Instagram} width="100%" alt="facebook logo" />
                  </div>
                </Col>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={Youtube} width="100%" alt="facebook logo" />
                  </div>
                </Col>
                <Col xs={2}>
                  <div className="d-flex align-items-center">
                    <img src={Linkedin} width="100%" alt="facebook logo" />
                  </div>
                </Col>
              </Row>
            </div>
